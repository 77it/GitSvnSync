...
$CommitMessage = ""
$Unattended = "False"
& $PSScriptRoot'.\lib-Git-Sync.stex.ps1' -Action $Action -WkPath $WkPath -BranchName $BranchName -BareRepoName $BareRepoName -BareRepoPath $BareRepoPath -CachePwdSec $CachePwdSec -LogFilePath $LogFilePath -Unattended $Unattended
